...
public:
    auto newPrimitive(PrimitiveTopology topology = PrimitiveTopology::Triangles) -> PrimitiveBuilder &;
  ...
  */
    ...
    auto grid(
        uint32_t nx, uint32_t ny, glm::vec3 center = {0.f, 0.f, 0.f}, glm::vec3 x = {0, 0, 1}, glm::vec3 y = {1, 0, 0},
        float wx = 1, float wy = 1) -> PrimitiveBuilder &;
    auto gridPatch(
        uint32_t nx, uint32_t ny, glm::vec3 center = {0.f, 0.f, 0.f}, glm::vec3 x = {0, 0, 1}, glm::vec3 y = {1, 0, 0},
        float wx = 1, float wy = 1) -> PrimitiveBuilder &;
    auto checkerboard(
  ...
  */
    auto circle(glm::vec3 center, glm::vec3 z, float R, int segments = 50) -> PrimitiveBuilder &;
    /**
  * generate a sphere
  ...
  */
    ...
    auto box(glm::vec3 p1, glm::vec3 p2, glm::vec3 up, float width, float height) -> PrimitiveBuilder &;
    /**
  * generate a cone
  ...
  * @return
  */
    auto cone(glm::vec3 center, glm::vec3 z, float R, int segments = 50) -> PrimitiveBuilder &;
    /**
  * generate a cylinder
  ...
  * @param segments  number of the edges of a polygon to simulate the circle.
  */
    auto cylinder(glm::vec3 center, glm::vec3 z, float R, bool cap = true, int segments = 50) -> PrimitiveBuilder &;
    /**
  ...
  * @param segments number of the edges of a polygon to simulate the circle.
  */
    auto axis(glm::vec3 center, float length, float R, float capLength, int segments = 10) -> PrimitiveBuilder &;
    /**
