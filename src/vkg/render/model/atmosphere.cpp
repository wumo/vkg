...
auto AtmosphereSetting::sunDirection() const -> const glm::vec3 & { return sunDirection_; }
...
void AtmosphereSetting::setSunIntensity(float sunIntensity) { sunIntensity_ = sunIntensity; }
...
auto AtmosphereSetting::lengthUnitInMeters() const -> double { return kLengthUnitInMeters_; }
