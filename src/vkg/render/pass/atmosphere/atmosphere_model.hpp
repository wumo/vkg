...
private:
    auto initParameter(
        ...
        double max_sun_zenith_angle, float length_unit_in_meters_, unsigned int num_precomputed_wavelengths,
    ...
    auto recordSingleScatteringCMD(vk::CommandBuffer cb, const glm::mat4 &luminance_from_radiance, vk::Bool32 cumulate)
        -> void;
    ...
    auto recordIndirectIrradianceCMD(
        vk::CommandBuffer cb, const glm::mat4 &luminance_from_radiance, int32_t scatteringOrder) -> void;

    auto createMultipleScatteringSets() -> void;
    auto recordMultipleScatteringCMD(vk::CommandBuffer cb, const glm::mat4 &luminance_from_radiance) -> void;
...
private:
    ...
    std::unique_ptr<Texture> deltaIrradianceTex, deltaRayleighScatteringTex, deltaMieScatteringTex,
    ...
    struct IndirectIrradianceLayoutDef: PipelineLayoutDef {
        __push_constant__(constant, vk::ShaderStageFlagBits::eCompute, ScatteringOrderLFUConstant);
