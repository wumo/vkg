...
static void errorFunc(int error, const char *msg) { println("glfw error: [", error, "] msg: ", msg); }
...
auto Window::createSurface(vk::Instance instance) -> void {
    ...
    surface = vk::UniqueSurfaceKHR{
        vk::SurfaceKHR{_surface}, vk::ObjectDestroy<vk::Instance, VULKAN_HPP_DEFAULT_DISPATCHER_TYPE>{instance}};
}
