...
PipelineQuery::PipelineQuery(vk::Device device): device{device} {
  ...
  info.pipelineStatistics =
    flag::eInputAssemblyVertices | flag::eInputAssemblyPrimitives |
    flag::eVertexShaderInvocations | flag::eGeometryShaderInvocations |
    flag::eGeometryShaderPrimitives | flag::eClippingInvocations |
    flag::eClippingPrimitives | flag::eFragmentShaderInvocations |
