...
public:
    ...
    auto input(uint32_t attachment, vk::ImageLayout layout = vk::ImageLayout::eShaderReadOnlyOptimal) -> SubpassMaker &;
    auto color(
        ...
        vk::ImageLayout resolveLayout = vk::ImageLayout::eColorAttachmentOptimal) -> SubpassMaker &;
    auto depthStencil(uint32_t attachment, vk::ImageLayout layout = vk::ImageLayout::eDepthStencilAttachmentOptimal)
        -> SubpassMaker &;
