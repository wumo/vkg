...
auto ComputePipelineMaker::createUnique(vk::PipelineCache pipelineCache) -> vk::UniquePipeline {
    shader_.make(device.vkDevice());
    auto sp = shader_.specializationInfo();
    vk::PipelineShaderStageCreateInfo stage{{}, vk::ShaderStageFlagBits::eCompute, shader_.shaderModule(), "main", &sp};
