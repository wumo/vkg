...
public:
    ...
    auto autoBinding(
        vk::ShaderStageFlags stageFlags, vk::DescriptorType descriptorType, uint32_t descriptorCount = 1,
        vk::DescriptorBindingFlags bindingFlag = {}, const vk::Sampler *pImmutableSamplers = nullptr)
        -> DescriptorSetLayoutMaker &;
    auto autoBindingIndex(
        vk::ShaderStageFlags stageFlags, vk::DescriptorType descriptorType, uint32_t descriptorCount = 1,
        vk::DescriptorBindingFlags bindingFlag = {}, const vk::Sampler *pImmutableSamplers = nullptr) -> uint32_t;
...
public:
   ...
   */
    auto layout(vk::DescriptorSetLayout layout, uint32_t variableDescriptorCount = 0) -> DescriptorSetMaker &;
    auto create(vk::Device device, vk::DescriptorPool descriptorPool) -> std::vector<vk::DescriptorSet>;
...
public:
    ...
    auto writeAccelerationStructure(uint32_t dstBinding, uint32_t dstArrayElement, vk::AccelerationStructureNV ASInfo)
