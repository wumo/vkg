...
auto GraphicsPipelineMaker::vertexInput(std::initializer_list<VertexInputBinding> bindings) -> GraphicsPipelineMaker & {
    for(const auto &binding: bindings) {
        ...
        for(const auto &attr: binding.attributes)
            _vertexAttributes.emplace_back(attr.location, attr.binding, attr.format, attr.offset);
    }
    return *this;
}

auto GraphicsPipelineMaker::vertexInputAuto(std::initializer_list<VertexInputAutoBinding> bindings)
...
auto GraphicsPipelineMaker::vertexInputBinding(const vk::VertexInputBindingDescription &binding)
    -> GraphicsPipelineMaker & {
    return *this;
}

auto GraphicsPipelineMaker::vertexInputAttribute(const vk::VertexInputAttributeDescription &attribute)
    -> GraphicsPipelineMaker & {
    return *this;
}

auto GraphicsPipelineMaker::inputAssembly(vk::PrimitiveTopology topology, vk::Bool32 restartEnable)
    -> GraphicsPipelineMaker & {
...
auto GraphicsPipelineMaker::tesselation(uint32_t patchControlPoints) -> GraphicsPipelineMaker & {
...
auto GraphicsPipelineMaker::depthClampEnable(vk::Bool32 value) -> GraphicsPipelineMaker & {
    _rasterizationState.depthClampEnable = value;
    return *this;
}
auto GraphicsPipelineMaker::rasterizerDiscardEnable(vk::Bool32 value) -> GraphicsPipelineMaker & {
    _rasterizationState.rasterizerDiscardEnable = value;
    return *this;
}
auto GraphicsPipelineMaker::polygonMode(vk::PolygonMode value) -> GraphicsPipelineMaker & {
...
auto GraphicsPipelineMaker::depthBiasConstantFactor(float value) -> GraphicsPipelineMaker & {
...
auto GraphicsPipelineMaker::rasterizationSamples(vk::SampleCountFlagBits value) -> GraphicsPipelineMaker & {
    _multisampleState.rasterizationSamples = value;
    return *this;
}
auto GraphicsPipelineMaker::sampleShadingEnable(vk::Bool32 value) -> GraphicsPipelineMaker & {
...
auto GraphicsPipelineMaker::pSampleMask(const vk::SampleMask *value) -> GraphicsPipelineMaker & {
    _multisampleState.pSampleMask = value;
    return *this;
}
auto GraphicsPipelineMaker::alphaToCoverageEnable(vk::Bool32 value) -> GraphicsPipelineMaker & {
    _multisampleState.alphaToCoverageEnable = value;
    return *this;
}
auto GraphicsPipelineMaker::alphaToOneEnable(vk::Bool32 value) -> GraphicsPipelineMaker & {
...
auto GraphicsPipelineMaker::depthWriteEnable(vk::Bool32 value) -> GraphicsPipelineMaker & {
    _depthStencilState.depthWriteEnable = value;
    return *this;
}
auto GraphicsPipelineMaker::depthCompareOp(vk::CompareOp value) -> GraphicsPipelineMaker & {
    _depthStencilState.depthCompareOp = value;
    return *this;
}
auto GraphicsPipelineMaker::depthBoundsTestEnable(vk::Bool32 value) -> GraphicsPipelineMaker & {
    _depthStencilState.depthBoundsTestEnable = value;
    return *this;
}
auto GraphicsPipelineMaker::stencilTestEnable(vk::Bool32 value) -> GraphicsPipelineMaker & {
...
auto GraphicsPipelineMaker::blendConstants(float r, float g, float b, float a) -> GraphicsPipelineMaker & {
...
auto GraphicsPipelineMaker::blendColorAttachment(vk::Bool32 enable) -> BlendColorAttachmentMaker {
...
BlendColorAttachmentMaker::BlendColorAttachmentMaker(GraphicsPipelineMaker &maker, uint32_t index)
...
auto BlendColorAttachmentMaker::srcColorBlendFactor(vk::BlendFactor value) -> BlendColorAttachmentMaker & {
    maker.colorBlendAttachments[index].srcColorBlendFactor = value;
    return *this;
}
auto BlendColorAttachmentMaker::dstColorBlendFactor(vk::BlendFactor value) -> BlendColorAttachmentMaker & {
    maker.colorBlendAttachments[index].dstColorBlendFactor = value;
    return *this;
}
auto BlendColorAttachmentMaker::colorBlendOp(vk::BlendOp value) -> BlendColorAttachmentMaker & {
    maker.colorBlendAttachments[index].colorBlendOp = value;
    return *this;
}
auto BlendColorAttachmentMaker::srcAlphaBlendFactor(vk::BlendFactor value) -> BlendColorAttachmentMaker & {
    maker.colorBlendAttachments[index].srcAlphaBlendFactor = value;
    return *this;
}
auto BlendColorAttachmentMaker::dstAlphaBlendFactor(vk::BlendFactor value) -> BlendColorAttachmentMaker & {
    maker.colorBlendAttachments[index].dstAlphaBlendFactor = value;
    return *this;
}
auto BlendColorAttachmentMaker::alphaBlendOp(vk::BlendOp value) -> BlendColorAttachmentMaker & {
    maker.colorBlendAttachments[index].alphaBlendOp = value;
    return *this;
}
auto BlendColorAttachmentMaker::colorWriteMask(vk::ColorComponentFlags value) -> BlendColorAttachmentMaker & {
    maker.colorBlendAttachments[index].colorWriteMask = value;
    return *this;
}

auto GraphicsPipelineMaker::dynamicState(vk::DynamicState value) -> GraphicsPipelineMaker & {
...
auto GraphicsPipelineMaker::renderPass(vk::RenderPass renderPass) -> GraphicsPipelineMaker & {
...
auto GraphicsPipelineMaker::shader(vk::ShaderStageFlagBits shaderStage, Shader &&shader) -> GraphicsPipelineMaker & {
    shaders[shaderStage] = std::move(shader);
    return *this;
}
auto GraphicsPipelineMaker::clearShader(vk::ShaderStageFlagBits shaderStage) -> GraphicsPipelineMaker & {
    shaders.erase(shaderStage);
    return *this;
}

auto GraphicsPipelineMaker::createUnique(vk::PipelineCache pipelineCache) -> vk::UniquePipeline {
    ...
    for(auto &[stage, shader]: shaders) {
        ...
        shader.make(device);
        stages.push_back(
            vk::PipelineShaderStageCreateInfo{{}, stage, shader.shaderModule(), "main", pSpecializationInfo});
    }
    ...
    vk::PipelineViewportStateCreateInfo viewportState{
        {}, uint32_t(_viewports.size()), _viewports.data(), uint32_t(_scissors.size()), _scissors.data()};

    vk::PipelineDynamicStateCreateInfo dynamicState{{}, uint32_t(_dynamicState.size()), _dynamicState.data()};
