...
auto DescriptorSetLayoutMaker::binding(
    vk::ShaderStageFlags stageFlags, uint32_t binding, vk::DescriptorType descriptorType, uint32_t descriptorCount,
    vk::DescriptorBindingFlags bindingFlag, const vk::Sampler *pImmutableSamplers) -> DescriptorSetLayoutMaker & {
    _bindings.emplace_back(binding, descriptorType, descriptorCount, stageFlags, pImmutableSamplers);
    bindingFlags.push_back(bindingFlag);
    useDescriptorIndexing = bool(bindingFlag);
    if(bindingFlag & vk::DescriptorBindingFlagBits::eUpdateAfterBind) updateAfterBind = true;
    errorIf(
    ...
    if(bindingFlag & vk::DescriptorBindingFlagBits::eVariableDescriptorCount) {
        errorIf(variableDescriptorBinding != -1, "variable descriptor binding should be the largest binding!");
        variableDescriptorBinding = binding;
    }
    return *this;
}

auto DescriptorSetLayoutMaker::bindings() const -> const std::vector<vk::DescriptorSetLayoutBinding> & {
    return _bindings;
}
auto DescriptorSetLayoutMaker::variableDescriptorCount() -> uint32_t {
    return variableDescriptorBinding == -1 ? 0 : _bindings[variableDescriptorBinding].descriptorCount;
}

auto DescriptorSetLayoutMaker::createUnique(vk::Device device) -> vk::UniqueDescriptorSetLayout {
    ...
    if(updateAfterBind) layoutCreateInfo.flags = vk::DescriptorSetLayoutCreateFlagBits::eUpdateAfterBindPool;
    return device.createDescriptorSetLayoutUnique(layoutCreateInfo);
}

auto DescriptorSetLayoutMaker::autoBinding(
    vk::ShaderStageFlags stageFlags, vk::DescriptorType descriptorType, uint32_t descriptorCount,
    vk::DescriptorBindingFlags bindingFlag, const vk::Sampler *pImmutableSamplers) -> DescriptorSetLayoutMaker & {
    autoBindingIndex(stageFlags, descriptorType, descriptorCount, bindingFlag, pImmutableSamplers);
    return *this;
};
auto DescriptorSetLayoutMaker::autoBindingIndex(
    vk::ShaderStageFlags stageFlags, vk::DescriptorType descriptorType, uint32_t descriptorCount,
    vk::DescriptorBindingFlags bindingFlag, const vk::Sampler *pImmutableSamplers) -> uint32_t {
    binding(stageFlags, autoBinding_, descriptorType, descriptorCount, bindingFlag, pImmutableSamplers);

    return autoBinding_++;
};
auto DescriptorSetLayoutMaker::setAutoBindingIndex(uint32_t binding) -> DescriptorSetLayoutMaker & {
...
auto DescriptorSetMaker::layout(vk::DescriptorSetLayout layout, uint32_t variableDescriptorCount)
    -> DescriptorSetMaker & {
...
auto DescriptorSetMaker::create(vk::Device device, vk::DescriptorPool descriptorPool)
    ...
    vk::DescriptorSetAllocateInfo allocateInfo{descriptorPool, uint32_t(layouts.size()), layouts.data()};
...
auto DescriptorSetUpdater::writeImages(
    uint32_t dstBinding, uint32_t dstArrayElement, vk::DescriptorType descriptorType, uint32_t descriptorCount,
    const vk::DescriptorImageInfo *pImageInfo) -> DescriptorSetUpdater & {
    vk::WriteDescriptorSet write{{}, dstBinding, dstArrayElement, descriptorCount, descriptorType, pImageInfo};
    descriptorWrites.push_back(write);
    return *this;
}
auto DescriptorSetUpdater::writeBuffers(
    uint32_t dstBinding, uint32_t dstArrayElement, vk::DescriptorType descriptorType, uint32_t descriptorCount,
    const vk::DescriptorBufferInfo *pBufferInfo) -> DescriptorSetUpdater & {
    vk::WriteDescriptorSet write{{},      dstBinding, dstArrayElement, descriptorCount, descriptorType,
                                 nullptr, pBufferInfo};
    descriptorWrites.push_back(write);
    return *this;
}
auto DescriptorSetUpdater::writeBufferViews(
    uint32_t dstBinding, uint32_t dstArrayElement, vk::DescriptorType descriptorType, uint32_t descriptorCount,
    const vk::BufferView *pTexelBufferView) -> DescriptorSetUpdater & {
    vk::WriteDescriptorSet write{{},      dstBinding, dstArrayElement, descriptorCount, descriptorType,
...
auto DescriptorSetUpdater::writeAccelerationStructures(
    uint32_t dstBinding, uint32_t dstArrayElement, uint32_t descriptorCount, const vk::AccelerationStructureNV *pASInfo)
    -> DescriptorSetUpdater & {
    vk::WriteDescriptorSet write{
        {}, dstBinding, dstArrayElement, descriptorCount, vk::DescriptorType::eAccelerationStructureKHR};
...
auto DescriptorSetUpdater::copy(
    vk::DescriptorSet srcSet, uint32_t srcBinding, uint32_t srcArrayElement, uint32_t dstBinding,
    uint32_t dstArrayElement, uint32_t descriptorCount) -> DescriptorSetUpdater & {
    descriptorCopies.emplace_back(
        srcSet, srcBinding, srcArrayElement, vk::DescriptorSet{}, dstBinding, dstArrayElement, descriptorCount);
    return *this;
}

auto DescriptorSetUpdater::writeImage(
    uint32_t dstBinding, uint32_t dstArrayElement, vk::DescriptorType descriptorType, vk::DescriptorImageInfo imageInfo)
    -> DescriptorSetUpdater & {
...
auto DescriptorSetUpdater::writeBufferView(
    uint32_t dstBinding, uint32_t dstArrayElement, vk::DescriptorType descriptorType, vk::BufferView texelBufferView)
    -> DescriptorSetUpdater & {
    vk::WriteDescriptorSet write{{}, dstBinding, dstArrayElement, 1, descriptorType};
    descriptorWrites.push_back(write);
...
auto DescriptorSetUpdater::writeAccelerationStructure(
    uint32_t dstBinding, uint32_t dstArrayElement, vk::AccelerationStructureNV ASInfo) -> DescriptorSetUpdater & {
    vk::WriteDescriptorSet write{{}, dstBinding, dstArrayElement, 1, vk::DescriptorType::eAccelerationStructureKHR};
...
auto DescriptorSetUpdater::update(vk::Device device, vk::DescriptorSet dstSet) -> void {
    ...
    for(auto [writeIndex, vectorIndex]: writeASInfoPtr)
        ((vk::WriteDescriptorSetAccelerationStructureNV *)descriptorWrites[writeIndex].pNext)->pAccelerationStructures =
            ASInfos.data() + vectorIndex;
