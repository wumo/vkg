...
auto SpcializationMaker::specializationInfo() const -> vk::SpecializationInfo { return specializationInfo_; }
...
auto Shader::make(vk::Device device) -> void { shaderModule_ = vkg::make(device, opcodesSpan); }
