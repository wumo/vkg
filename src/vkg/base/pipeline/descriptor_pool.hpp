...
private:
    ...
    uint32_t _numSampler{0}, _numCombinedImageSampler{0}, _numSampledImage{0}, _numStorageImage{0},
        _numUniformTexelBuffer{0}, _numStorageTexelBuffer{0}, _numUniformBuffer{0}, _numStorageBuffer{0},
        _numUniformDynamic{0}, _numStorageBufferDynamic{0}, _numInputAttachment{0}, _numInlineUniformBlock{0},
