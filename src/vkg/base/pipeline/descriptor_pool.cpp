...
auto DescriptorPoolMaker::pipelineLayout(const PipelineLayoutDef &def, uint32_t num)
  -> DescriptorPoolMaker & {
...
auto DescriptorPoolMaker::setLayout(const DescriptorSetDef &def, uint32_t num)
  -> DescriptorPoolMaker & {
  ...
  for(auto &binding: setDef.bindings())
    switch(binding.descriptorType) {
      case vk::DescriptorType::eSampler:
        _numSampler += binding.descriptorCount * num;
        break;
      case vk::DescriptorType::eCombinedImageSampler:
        _numCombinedImageSampler += binding.descriptorCount * num;
        break;
      case vk::DescriptorType::eSampledImage:
        _numSampledImage += binding.descriptorCount * num;
        break;
      case vk::DescriptorType::eStorageImage:
        _numStorageImage += binding.descriptorCount * num;
        break;
      ...
      case vk::DescriptorType::eUniformBuffer:
        _numUniformBuffer += binding.descriptorCount * num;
        break;
      case vk::DescriptorType::eStorageBuffer:
        _numStorageBuffer += binding.descriptorCount * num;
        break;
      case vk::DescriptorType::eUniformBufferDynamic:
        _numUniformDynamic += binding.descriptorCount * num;
        break;
      case vk::DescriptorType::eStorageBufferDynamic:
        _numStorageBufferDynamic += binding.descriptorCount * num;
        break;
      case vk::DescriptorType::eInputAttachment:
        _numInputAttachment += binding.descriptorCount * num;
        break;
