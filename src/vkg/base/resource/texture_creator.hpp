...
auto make2DTex(
  ...
  vk::ImageUsageFlags usage, vk::Format format = vk::Format::eR8G8B8A8Unorm,
...
auto make2DArrayTex(
  ...
  vk::SampleCountFlagBits sampleCount, vk::ImageAspectFlags aspect,
...
auto makeStorageAtt(
  const std::string &name, Device &device, uint32_t width, uint32_t height,
  vk::Format format, vk::SampleCountFlagBits sampleCount = vk::SampleCountFlagBits::e1)
  -> std::unique_ptr<Texture>;
